...
$endif$
$if(supporting-files)$
\small{{\bf Supporting information}: Additional supporting information can be found $for(supporting-files)$\href{https://$github-user$.github.io/$github-repo$/$supporting-files$.pdf}{here}$sep$, $endfor$.}\\\\
$endif$
$if(acknowledgments)$
